...
import { AppBar, Toolbar, Box, IconButton, Menu, MenuItem, Divider } from "@mui/material";
        ...
        <Box>
            <AppBar position="fixed" component="nav" className={classes.navbar}>
                <Toolbar className={classes.toolbar} disableGutters sx={{ display: { xs: 'none', md: 'flex' }}}>
                    <Link to={"/"} key={"/"}>
                        <span className={classnames(classes.toolbarItem, classes.logo)}>
                            {"Architetto Salvatore Ciantia"}
                        </span>
                    </Link>
                    <Box>
                        {menuItems.map((item) => {
                            return (
                                <Link to={item.link} key={item.link}>
                                    <span className={classnames(classes.toolbarItem)}>
                                        {item.label}
                                    </span>
                                </Link>
                            )
                ...
                <Box className={classes.menubar}>
                    ...
                    <IconButton aria-label="more"id="long-button" aria-haspopup="true" onClick={handleMenuClick}>
                        <MoreVertIcon />
                    </IconButton>
                    ...
                    >
                        {menuItems.map((item) => (
                            <Link to={item.link} key={item.link}>
                                <MenuItem key={item.link} selected={isMenuItemSelected(item.label)} onClick={handleMenuClose}>
                                    {item.label}
                                </MenuItem>
                            </Link>
                        ))}
